...
class CourseAppTest {
    ...
    private val courseApp = app // rename
    ...
    inner class StaffBots {
        ...
        fun `A user in the channel can ask the bot to do calculation`() {
            ...
            verify {
                ...
                listener.invoke("#channel@Anna0", match { it.contents.toString(Charsets.UTF_8).toInt() == 42 })
            }
        }
        ...
        fun `The bot accurately tracks keywords`() {
            ...
            assertThat(runWithTimeout(ofSeconds(10)) {
                ...
                bots.bot("Anna0").thenCompose { bot -> bot.count(null, ".*hell.*worl.*") }.join() // missing null for channel
            }, equalTo(1L))
        }
