...
internal class MaxHeapTest {
    ...
    fun `big scores`() {
        ...
        assertEquals(heap.getScore("3009"), 10000000)
        assertEquals(heap.getScore("3005"), 1000)
        assertEquals(heap.getScore("3001"), 100000000)
        assertEquals(heap.getScore("3002"), 100000)
        assertEquals(heap.getScore("3008"), 9)
        assertEquals(heap.getScore("3010"), 1000000)
        assertEquals(heap.getScore("3004"), 1000000000)
        assertEquals(heap.getScore("3007"), 10)
        assertEquals(heap.getScore("3003"), 10000)
        assertEquals(heap.getScore("3006"), 100)
